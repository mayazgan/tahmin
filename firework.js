...
L.top = Ypos + E*Math.sin((C+i*5)/3)*Math.sin(C/135)
L.left= Xpos + E*Math.cos((C+i*5)/3)*Math.sin(C/135)
if (C < 110){
if (NS4){L.bgColor=I;L.clip.width=5;L.clip.height=5}
if (IE4||document.getElementById)
{L.background=I;L.width=5;L.height=5;L.fontSize=5}
}
else{
